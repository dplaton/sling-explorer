        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info"><i class="glyphicon glyphicon-folder-open"></i><%=resource.getPath()%>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" type="submit" name=":applyTo" value="<%=resource.getPath()%>"><i
